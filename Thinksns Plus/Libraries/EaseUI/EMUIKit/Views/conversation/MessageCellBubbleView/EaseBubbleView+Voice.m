...
//    [self.marginConstraints addObject:imageWithMarginBottomConstraint];
    ...
    NSLayoutConstraint *imageWithMarginWithConstraint = [NSLayoutConstraint constraintWithItem:self.voiceImageView attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.0 constant:16];
    NSLayoutConstraint *imageWithMarginHeightConstraint = [NSLayoutConstraint constraintWithItem:self.voiceImageView attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.0 constant:16];
    [self.marginConstraints addObject:imageWithMarginWithConstraint];
    [self.marginConstraints addObject:imageWithMarginHeightConstraint];
    // NSLayoutAttributeCenterY
    NSLayoutConstraint *durationWithMarginCenterYConstraint = [NSLayoutConstraint constraintWithItem:self.voiceImageView attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:self.backgroundImageView attribute:NSLayoutAttributeCenterY multiplier:1.0 constant:0];
    [self.marginConstraints addObject:durationWithMarginCenterYConstraint];
