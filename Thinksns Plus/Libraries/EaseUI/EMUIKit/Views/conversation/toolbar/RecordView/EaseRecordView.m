...
+ (void)initialize
{
    ...
    recordView.voiceMessageAnimationImages = @[@"ico_yuyin001",@"ico_yuyin002",@"ico_yuyin003",@"ico_yuyin004",@"ico_yuyin005",@"ico_yuyin006"];
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _recordAnimationView = [[UIImageView alloc] initWithFrame:CGRectMake((self.frame.size.width - 105) / 2.0, (self.frame.size.height - 90 - 25) / 2.0, 105, 90)];
