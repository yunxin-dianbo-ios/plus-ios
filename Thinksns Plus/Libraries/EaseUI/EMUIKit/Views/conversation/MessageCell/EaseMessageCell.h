...
#import <TYAttributedLabel/TYLinkTextStorage.h>
...
/** @brief 位置消息cell的高度 */
#define kEMMessageLocationHeight 117
/** @brief 语音消息cell的高度 */
...
@interface EaseMessageCell : UITableViewCell<IModelChatCell,TYAttributedLabelDelegate,TYTextStorageProtocol>
{
...
/*
    点击聊天内的图片
    由于聊天详情页内大图查看器需要知道小图在window上的frame
    然后用来做缩放动画
 */
 ...
 *  @param  消息model
 */
- (void)urlTouch:(NSString *)urlString;
@end
